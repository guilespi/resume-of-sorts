...
(function () {
	var shippedProducts = [
		{ id : "Analyics", 
			...
			skills : ["c++", "lua", "javascript", "Cassandra", "Redis", "Solr", "git", "jenkins", "selenium"]
		},
		{ id : "Agent", 
		...
		{ id : "Supervisor", 
			...
			skills : ["c++", "lua", "javascript", "SQL Server"]
		},
		{ id : "Administrator", 
			...
			description : ''.concat("Engineered and delivered a multitenant contact center solution in order to facilitate the company transition to the cloud.\n", "</br>",
										"Supporting different hosted and remote workers scenarios, high latency and jittered network conditions were common use cases solved."),
		...
		{ id : "Asterisk", 
			...
			skills : ["c", "Asterisk", "SIP", "ISDN", "IAX", "gdb"]
		},
		{ id : "H3Recording", 
	...
	function createTeamChart() {
		...
		var years = ["97", "98", "99", "00", "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12", "13"];
		var values = [1, 6, 7, 7, 3, 4, 5, 5, 6, 8, 11, 14, 15, 14, 14, 14, 1];
		var colors = ["#E9E581", "#E9E581", "#E9E581", "#E9E581", "#2B2B2B", "#2B2B2B", "#2B2B2B", "#2B2B2B", 
									"#2B2B2B", "#2B2B2B", "#2B2B2B", "#2B2B2B", "#2B2B2B", "#2B2B2B", "#2B2B2B", "#2B2B2B", "#DE1B1B"];
    ...
    Raphael("coxcomb-skills", paperWidth, paperHeight).coxCombChart(paperWidth / 2, 
							paperHeight / 2, paperHeight / 2, skills, properties);
	};
